                        ...
                        <div class="col-sm-6">
                          <div class="card shadow">
                            ...
                            <div class="card-body">
                              <div class="row">
                                <div class="col-md-6">
                                  ...
                                  <p class="color1"><?= $produk['jenis_voucher'] ?></p>
                                </div>

                                 <div class="col-md-6">
                                  <h5 class="text-black p-b-10">Jenis Paket</h5>
                                  <p class="color1"><?= $produk['jenis_produk'] ?></p>
                                </div>

                                 <div class="col-md-6">
                                  <h5 class="text-black p-b-10">Bonus Sponsor</h5>
                                  <p class="color1"><?= $produk['bonus_sponsor'] ?>%</p>
                                </div>

                                 <div class="col-md-6">
                                  <h5 class="text-black p-b-10">Bonus Point</h5>
                                  <p class="color1"><?= $produk['bonus_point'] ?></p>
                                </div>

                                <div class="col-md-6">
                                  <h5 class="text-black p-b-10">Jumlah Voucher</h5>
                                  <p class="color1"><?= $produk['jumlah_voucher'] ?> voucher</p>
                                </div>

                                 <div class="col-md-6">
                                  <h5 class="text-black p-b-10">Nilai Voucher</h5>
                                  <p class="color1">Rp. <?= $produk['nilai_voucher']  ?> /voucher</p>
                                </div>

                                 <div class="col-md-6">
                                  <h5 class="text-black p-b-10">Harga Voucher</h5>
                                  <p class="color1">Rp. <?= $produk['harga']  ?></p>
                                </div>
                              </div>
                            ...
                            <div class="card-footer">
                             <label><strong>Total : </strong></label> Rp.<?= $produk['harga'] ?>
                            </div>
                          </div>
                        </div>
        ...
        <div class="modal-content">
          ...
          <input type="text" name="sc_code" class="form-control" placeholder="Masukan security code anda" required="" v-model="cek_sc" v-on:keyup.enter="cek">
            ...
            <div class="spinner-border text-primary" v-if="loading == true" role="status">
              ...
              <form method="post" action="<?= base_url() ?>user/act_keranjang_cicil">
               
                <input type="text" name="kode_produk" value="<?= $produk['kode_produk'] ?>">
                <input type="text" name="bonus_sponsor" value="<?= $produk['bonus_sponsor'] ?>">
                <input type="text" name="produk_tujuan" value="<?= $produk['jenis_produk'] ?>">
